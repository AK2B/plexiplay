...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220620_aurelieanger_0e4249384daadd191620_20220620075925_archive.zip';
	const ARCHIVE_SIZE		 = '136081205';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '0e42493-20075925';
    const SECONDARY_PACKAGE_HASH = '40857b1-20075925';
	const VERSION			 = '1.4.6';
